...
-- mocelet 2024
-- tweaks: Stock init.lua removing added_handler and unused subdrivers
...
local zigbee_button_driver_template = {
  ...
  sub_drivers = {
    -- tweak: removed all and added the ikea subdriver directly. Stock zigbee-multi-button/init.lua no longer necessary (deleted)
