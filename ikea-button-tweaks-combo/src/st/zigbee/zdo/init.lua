...
--
-- THIS FILE IS A TEMPORARY MITIGATION FOR HUB FW 57.X BUG, CAN BE DELETED WHEN ALL HUBS ARE UPDATED.
-- SEE: https://community.smartthings.com/t/did-a-hub-firmware-update-break-ikea-buttons-binding/301814/6
-- ALSO: https://github.com/SmartThingsCommunity/SmartThingsEdgeDrivers/pull/2218
--
